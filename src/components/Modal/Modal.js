...
const Modal = props => {
  return (
    <div className="fixed h-full w-full bg-gray-800 bg-opacity-50">
      <div className="w-full h-full flex items-center justify-center">
        <div className="w-full max-w-md mx-auto">
          <div className="rounded-lg">
            <div className="border-b border-gray-200 bg-gray-100 px-8 py-2 rounded-t-lg">
              <div className="flex items-center justify-between">
                <h2 className="text-gray-800 font-bold text-md">Add project</h2>
                <Button
            ...
            <div className="overflow-y-scroll p-8 bg-white">
              <div className="text-gray-800">
                <div className="w-full mb-4">
                  <h3 className="text-sm text-gray-800 font-bold mb-2">Name</h3>
                  <input
                    type="text"
                ...
                <div className="w-full mb-4">
                  <h3 className="text-sm text-gray-800 font-bold mb-2">View</h3>
                  <ViewLayoutSelector />
                </div>
                <div className="w-full mb-4">
